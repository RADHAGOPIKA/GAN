...
parser.add_argument('--train_file_list', type=str, default='/content/DFA/data/oulu_twostream/Protocol_2/Train.txt', help='train_file_list')
parser.add_argument('--dev_file_list', type=str, default='/content/DFA/data/oulu_twostream/Protocol_2/Dev.txt', help='dev_file_list')
parser.add_argument('--test_file_list', type=str, default='/content/DFA/data/oulu_twostream/Protocol_2/Test.txt', help='test_file_list')
